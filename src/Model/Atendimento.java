...
@NamedQueries({
    ...
    @NamedQuery(name = "Atendimento.findByStatus", query = "SELECT a FROM Atendimento a WHERE a.codstatusatendimento = :status "
            + "order by a.dataAgendamento,a.codprioridade"),
    @NamedQuery(name = "Atendimento.findByStatusAndUsuario", query = "SELECT a FROM Atendimento a WHERE a.codstatusatendimento = "
            + ":status and a.codusuario = :codUsuario order by a.dataAgendamento,a.codprioridade"),
    })

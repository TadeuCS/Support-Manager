 ...
 * @author Tadeu
 */
public class Frm_CadTipoInformacao extends javax.swing.JFrame {

    TipoInformacaoDAO tipoInformacaoDAO;
    TipoInformacao tipoInformacao;

    public Frm_CadTipoInformacao() {
        initComponents();
        setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm_CadTipoInformacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frm_CadTipoInformacao().setVisible(true);
            }
        });
    }

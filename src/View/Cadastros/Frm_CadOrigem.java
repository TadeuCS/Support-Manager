 ...
 * @author Tadeu
 */
public class Frm_CadOrigem extends javax.swing.JFrame {

    OrigemDAO origemDAO;
    Origem origem;

    public Frm_CadOrigem() {
        initComponents();
        setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm_CadOrigem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frm_CadOrigem().setVisible(true);
            }
        });
    }

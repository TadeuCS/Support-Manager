 ...
 * @author Tadeu
 */
public class Frm_ConAtendimento_Execução extends javax.swing.JFrame {

    DefaultTableModel model;
    ClienteDAO clienteDAO;
    public Frm_ConAtendimento_Execução() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm_ConAtendimento_Execução.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frm_ConAtendimento_Execução().setVisible(true);
            }
        });
    }

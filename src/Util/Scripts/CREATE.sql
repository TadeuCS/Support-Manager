CREATE TABLE SALARIOS (
  CODSALARIO int(10) NOT NULL AUTO_INCREMENT, 
  ANO        year NOT NULL, 
  VALOR      double NOT NULL, 
  PRIMARY KEY (CODSALARIO));
CREATE TABLE PARCELA (
  CODPARCELA int(10) NOT NULL AUTO_INCREMENT, 
...
ALTER TABLE TELEFONE ADD INDEX FKTELEFONE623989 (CODEMPRESA), ADD CONSTRAINT FKTELEFONE623989 FOREIGN KEY (CODEMPRESA) REFERENCES EMPRESA (CODEMPRESA);
ALTER TABLE ENDERECO ADD INDEX FKENDERECO63562 (CODEMPRESA), ADD CONSTRAINT FKENDERECO63562 FOREIGN KEY (CODEMPRESA) REFERENCES EMPRESA (CODEMPRESA);
ALTER TABLE CLIENTE ADD INDEX FKCLIENTE779415 (CODPARCELA), ADD CONSTRAINT FKCLIENTE779415 FOREIGN KEY (CODPARCELA) REFERENCES PARCELA (CODPARCELA);

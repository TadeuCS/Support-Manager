...
public class QRCode {
    ...
    private static String getCaminho(String arquivo) {
        ...
        return file.getAbsolutePath().replaceAll(arquivo, "").concat("src\\Util\\Img\\"+arquivo);
    }
    
    public static void geraQRCode(String link){
        int size = 125;
        String fileType = "jpg";
        File myFile = new File(getCaminho("QRCode.jpg"));
        try {
